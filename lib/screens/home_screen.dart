                          ...
                          Container(
                            ...
                            child: Builder(
                              builder: (BuildContext context) {
                                ...
                                final bannerOverlapSpace = 75.0; // Increased from 73.0 to give more bottom space
                                final minTopPadding = 35.0; // Increased from 30.0
                                final maxTopPadding = 60.0; // Increased from 50.0
                                final availableHeaderSpace = screenHeight * 0.18; // Increased from 0.15 for taller header
